...
app.use('/api/auth/login/verify-email', authLimiter);
app.use('/api/auth/login/resend-email-code', authLimiter);
app.use('/api/auth/login/2fa-setup', authLimiter);
app.use('/api/auth/login/2fa-confirm', authLimiter);
